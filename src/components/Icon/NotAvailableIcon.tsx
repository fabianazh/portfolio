export default function NotAvailableIcon({
    className,
}: {
    className?: string
}) {
        ...
        <>
            ...
            >
                ...
                <path
                    ...
                    fill="#2f2e41"
                />
                <circle cx="559" cy="744.5" r="43" fill="#acabbb" />
                <circle cx="54" cy="729.5" r="43" fill="#acabbb" />
                <circle cx="54" cy="672.5" r="31" fill="#acabbb" />
                <circle cx="54" cy="624.5" r="22" fill="#acabbb" />
            </svg>
        </>
    )
}
